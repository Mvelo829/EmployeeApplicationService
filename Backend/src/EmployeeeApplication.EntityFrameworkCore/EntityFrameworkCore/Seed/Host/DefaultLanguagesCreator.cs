...
namespace EmployeeeApplication.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly EmployeeeApplicationDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = EmployeeeApplicationConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(EmployeeeApplicationDbContext context)
        {
            _context = context;
        }
